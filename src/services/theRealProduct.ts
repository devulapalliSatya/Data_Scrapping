...
export const theRealProductDetailsScraperObject = {
    ...
    async findTheRealProductUrls({ urls, browserInstance, lastPage }: any) {
        ...
        try {
            ...
            await page.goto("https://www.therealreal.com/designers", { waitUntil: 'networkidle0' });
            ...
            let email = await page.waitForSelector('input[name="user[email]"]');
            await email.focus();
            await email.type("sauravm807@gmail.com", { delay: 300 });
            //await page.type('#user_email', 'sauravm807@gmail.com', { delay: 100 });
            let password = await page.waitForSelector('input[name="user[password]"]');
